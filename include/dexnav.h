...
#define VISIBLE_ROW_WATER_COUNT  1
#define VISIBLE_ROW_LAND_COUNT   2
#define VISIBLE_ROW_HIDDEN_COUNT 1

#define COL_WATER_MAX           (COL_WATER_COUNT  - 1)
#define COL_LAND_MAX            (COL_LAND_COUNT   - 1)
#define COL_HIDDEN_MAX          (COL_HIDDEN_COUNT - 1)

#define TOTAL_ROW_WATER_COUNT  (((WATER_WILD_COUNT  - 1) / COL_WATER_COUNT)  + 1)
#define TOTAL_ROW_LAND_COUNT   (((LAND_WILD_COUNT   - 1) / COL_LAND_COUNT)   + 1)
#define TOTAL_ROW_HIDDEN_COUNT (((HIDDEN_WILD_COUNT - 1) / COL_HIDDEN_COUNT) + 1)

#define VISIBLE_WATER_COUNT   (VISIBLE_ROW_WATER_COUNT  * COL_WATER_COUNT)
#define VISIBLE_LAND_COUNT    (VISIBLE_ROW_LAND_COUNT   * COL_LAND_COUNT)
#define VISIBLE_HIDDEN_COUNT  (VISIBLE_ROW_HIDDEN_COUNT * COL_HIDDEN_COUNT)

#define MAX_SCROLL_LAND   (TOTAL_ROW_LAND_COUNT   - VISIBLE_ROW_LAND_COUNT)
#define MAX_SCROLL_WATER  (TOTAL_ROW_WATER_COUNT  - VISIBLE_ROW_WATER_COUNT)
#define MAX_SCROLL_HIDDEN (TOTAL_ROW_HIDDEN_COUNT - VISIBLE_ROW_HIDDEN_COUNT)
