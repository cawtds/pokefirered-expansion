...
#define TOTAL_LAND_COUNT   (((LAND_WILD_COUNT - 1) / COL_LAND_COUNT + 1) * COL_LAND_COUNT)
#define TOTAL_WATER_COUNT  (((WATER_WILD_COUNT - 1) / COL_WATER_COUNT + 1) * COL_WATER_COUNT)
#define TOTAL_HIDDEN_COUNT (((HIDDEN_WILD_COUNT - 1) / COL_HIDDEN_COUNT + 1) * COL_HIDDEN_COUNT)
