...
// char (*test)[sizeof(struct SaveBlock2) - SECTOR_DATA_SIZE] = 1;
// char (*test)[SECTOR_DATA_SIZE * (SECTOR_ID_SAVEBLOCK1_END - SECTOR_ID_SAVEBLOCK1_START + 1) - sizeof(struct SaveBlock1)] = 1;
